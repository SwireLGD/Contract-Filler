...
const Survey = () => {
  ...
  return (
    ...
    <Box sx={{ p: 4 }}>
      ...
      <Typography variant='h5' gutterBottom>
        3. Информация о верификации, проверке и уровне риска (заполняется финансовым учреждением и
        нефинансовой категорией лиц)
      </Typography>
      ...
      <Typography variant='h6' gutterBottom>
        3. Сведения о проверке клиента в Перечне физических лиц, отбывших наказание за осуществление
        легализации (отмывания) преступных доходов, террористической или экстремистской
      ...
      <Box>
        ...
        <TextField fullWidth placeholder='ФИО / представителя' variant='outlined' size='small' />
        ...
        <Typography variant='body1' align='justify' sx={{ mt: 2 }}>
          В соответствии с требованиями Закона Кыргызской Республики "Об информации персонального
          характера" даю согласие на обработку персональных данных в целях выполнения требований
